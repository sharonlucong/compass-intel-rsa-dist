        ...
        $stateProvider
          ...
          .state 'serverList',
            ...
            resolve:
              ...
              rsaExistingMachinesData: ['$q', 'wizardService', ($q, wizardService) ->
                  deferred = $q.defer();
                  wizardService.getExistingRsaMachines().success((data) ->  #CHI  
                      deferred.resolve(data);
                  )
                  return deferred.promise;
              ]
          .state 'physicalResource',
            url:'/physicalResource'
            controller: 'rsaCtrl'
            templateUrl:'src/app/partials/physicalResource.tpl.html'
            requireAuthenticated: true
          .state 'userSetting',
            url: '/userSetting'

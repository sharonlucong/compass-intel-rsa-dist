(function() {
  define(['./baseFactory'], function() {
    ...
    WizardFactory = (function() {
      ...
      WizardFactory.prototype.setRsaMachines = function(machines) {
        return this.rsaAllMachines = machines;
      };

      WizardFactory.prototype.getRsaMachines = function() {
        return this.rsaAllMachines;
      };

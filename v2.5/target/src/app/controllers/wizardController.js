  ...
  define(['./baseController'], function() {
    ...
    return angular.module('compass.controllers').controller('wizardCtrl', [
      ...
      '$scope', 'wizardService', '$filter', 'ngTableParams', '$modal', function($scope, wizardService, $filter, ngTableParams, $modal) {
        ...
        $scope.rsaHideUnselected = function() {
          if ($scope.rsaHideunselected) {
            return $scope.searchRSA.check = true;
          } else {
            return delete $scope.searchRSA.check;
          }
        };
        $scope.ifPreSelect = function(server) {
          var svCluster, _i, _len, _ref;
        ...
        $scope.rsaSelectAllMachine = function(flag) {
          var sv, _i, _j, _len, _len1, _ref, _ref1, _results, _results1;
          if (flag) {
            _ref = $scope.allRSAMachines;
            _results = [];
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              sv = _ref[_i];
              _results.push(sv.check = true);
            }
            return _results;
          } else {
            ...
            for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
              sv = _ref1[_j];
              _results1.push(sv.check = false);
            }
            return _results1;
          }
        };
        $scope.rsaSelectAllBaseUrl = function(flag) {
          var url, _i, _j, _len, _len1, _ref, _ref1, _results, _results1;
          if (flag) {
            _ref = $scope.rsaBaseURLs;
            _results = [];
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              url = _ref[_i];
        ...
        $scope.rsaDiscoverServers = function() {
          var count, rsaBaseUrl, _i, _len, _ref;
          count = 0;
          _ref = $scope.rsaBaseURLs;
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            rsaBaseUrl = _ref[_i];
        ...
        $scope.ifRsaPreSelect = function(server) {
          var svCluster, _i, _len, _ref;
          server.disabled = false;
          if (server.host && server.host.clusters) {
            if (server.host.clusters.length > 0) {
              server.disabled = true;
            }
            server.check = false;
            _ref = server.host.clusters;
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              svCluster = _ref[_i];
              if (svCluster === $scope.cluster.name) {
                server.check = true;
                server.disabled = false;
              }
            }
